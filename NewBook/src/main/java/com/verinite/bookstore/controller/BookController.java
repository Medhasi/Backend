...
public class BookController {
	...
	public List<Map<String, String>> getById(@PathVariable("bookId") int bookId) {
		return bookService.getById(bookId);
	}
	@GetMapping("/viewBookbyId/{bookId}")
	public Object getById1(@PathVariable("bookId") int bookId) {
		return bookService.getById1(bookId);
	}
