...
public interface BookRepository extends JpaRepository<Book,Integer> {
	...
	@Query(value="select b.book_id,b.book_title,b.description,b.book_price,b.pic_byte,s.stock_id,s.quantity from tbl_book b inner join stock s on b.book_id=s.book_id where b.is_deleted=false",nativeQuery = true)
