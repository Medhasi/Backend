...
import com.verinite.bookstore.feignclient.PaymentClient;
...
//	}
	...
	{
		return pc.getAllPayment();
	}
	@PostMapping("/feignPost")
	public Payment postFeign(@RequestBody Payment payment)
	{
		
		return pc.savePayment(payment);
	}
